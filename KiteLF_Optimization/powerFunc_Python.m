...
% xSite = [5,2];
% uGeo = [10.2332 3.8024 7.6341 0.4672]; %See 3 lines below for what these are
...
SFOTParams.NtimeSteps = 87; %Define number of time steps 87 hours from the medium Fidelity
