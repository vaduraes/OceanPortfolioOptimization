function [Power,aOpt,Fwing,CLCD] = PerfCalc(SFOTParams,uGeo,uDep,vel)
...
if theta > 30
    ...
    lthr_eff = lthr*sind(theta)/sind(30)/4;
end
Sthr = Diathr*(lthr_eff);                                                           %0.25 tether length straight assummption
